...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.action_tj:
                ...
                itemView=info.targetView;
                textId =(TextView)itemView.findViewById(R.id.textId);
                final String strId1 = textId.getText().toString();
               textId.setOnClickListener( new View.OnClickListener() {
                   @Override
                   public void onClick(View view) {

                   Intent intent = new Intent(MainActivity.this,ScbActivity.class);
                   intent.putExtra( "extra_data",strId1 );
                   startActivity( intent );
                   }
               } );
    ...
    /*使用sql语句添加到生词本
    private void addUserSql(String strId) {
    ...
    //添加到生词本对话框
    private void addDialog(final String strId){
